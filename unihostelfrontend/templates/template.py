import reflex as rx
from ..components.navbar import navbar, admin_navbar # Import the navbar component
...
def admin_base_template(content: rx.Component, title: str = "UniHostel") -> rx.Component:
    """Base template with a navbar and page-specific content."""
    return rx.vstack(

        admin_navbar(),  # Include the navbar below the title bar
       rx.box(
            content,  # Page-specific content
            padding_top="8rem",  # Padding to avoid overlap with the fixed navbar
            width="100%",
